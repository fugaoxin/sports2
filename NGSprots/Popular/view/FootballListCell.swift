...
class FootballListCell: UICollectionViewCell {
    ...
    var delegate: FootballListCellDelegate?
    ...
    func setUI(){
        ...
        //print("identifierId=111==\(identifierId)")
        collectionview.register(UINib(nibName: "BettingCell", bundle: nil), forCellWithReuseIdentifier: identifierId)
    }
...
extension FootballListCell: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, BettingCellDelegate{
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        //print("identifierId=222==\(identifierId)")
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: identifierId, for: indexPath) as! BettingCell
...
//            }
            if models[indexPath.row].nm == "Home" || models[indexPath.row].nm == "Away"{
                cell.leftLabel.text = "\(models[indexPath.row].ty ?? 0)"
            }else if models[indexPath.row].nm == "Draw"{
                cell.leftLabel.text = "X"
            }else{
                cell.leftLabel.text = models[indexPath.row].nm
            }
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        return CGSize(width: 87, height: 70)
    }
