...
class BasketballListCell: UICollectionViewCell {
    ...
    var delegate: BasketballListCellDelegate?
    @IBOutlet weak var saitimeTop: NSLayoutConstraint!
...
extension BasketballListCell: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, BettingCellDelegate{
